        ...
        <div style={{ display: "flex", alignItems: "center", gap: "clamp(7px,1vw,14px)", flexWrap: "wrap" }}>
          {[
            ...
            { label: "Max", href: "#", bg: "linear-gradient(135deg,#3b82f6,#8b5cf6)",
              icon: <img src="https://cdn.poehali.dev/projects/cd804f06-8b0b-4247-96bf-3eb513cea81f/bucket/0ef9b0a4-f424-4e4f-8a5d-1c046a9df58b.png" width="18" height="18" style={{borderRadius:4, objectFit:"cover"}} /> },
          ].map(s => (
            <a
              key={s.label}
              href={s.href}
