  ...
  return (
    <footer id="contact" className="bg-background border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        {/* Мобайл: одна колонка, Десктоп: 4 колонки */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          {/* Мобайл: Категории + Компания в одной строке */}
          ...
          {/* Contacts */}
          <div>
            <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Контакты</h4>
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-1.5">
                ...
                <span>ул. Героя Яцкова 19к3, <span className="text-foreground font-medium">г. Краснодар</span></span>
              </li>
