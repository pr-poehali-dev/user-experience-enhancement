...
const compositions: Record<string, Composition[]> = {
  ...
  discharge: [
    ...
    { id: 7, image: "https://cdn.poehali.dev/files/7efb89d9-d63a-40d0-be6f-5276af79609f.jpg", title: "Облака с метриками", description: "Белые шары-облака с мимикой, фольгированное сердце с метриками и баблс-шар с надписью. Под потолком — золотые, кремовые и серебристые шары.", price: "Цена по запросу", priceNum: 0, colors: ["white", "gold", "silver"], subcategory: "girl-discharge" },
    { id: 8, image: "https://cdn.poehali.dev/files/9624e189-d4e9-4cb7-8c57-1b60dad56e18.jpg", title: "Баблс с золотом", description: "Большой прозрачный шар с золотыми шарами внутри и розовыми кистями. Вокруг — розовые и золотые конфетти-шары.", price: "Цена по запросу", priceNum: 0, colors: ["pink", "gold"], subcategory: "girl-discharge" },
    { id: 9, image: "https://cdn.poehali.dev/files/366ec844-7659-4023-bb44-0b120c77675f.jpg", title: "Сердце с метриками и мишкой", description: "Большое розовое сердце с метриками, голубой шар-облако с мимикой и россыпь розовых, кремовых шаров.", price: "Цена по запросу", priceNum: 0, colors: ["pink", "beige", "white"], subcategory: "girl-discharge" },
    { id: 10, image: "https://cdn.poehali.dev/files/1f042c33-647b-4593-826d-e1bba408c5a2.jpg", title: "Сердце с мишками и бантом", description: "Большое розовое сердце с метриками, фольгированный бант, два шара-мишки и нежные розово-белые шары.", price: "Цена по запросу", priceNum: 0, colors: ["pink", "beige"], subcategory: "girl-discharge" },
  ],
}
